...
def _get_doc(N_CYCLE, spindle_event_name):
    ...
    {            # The valid duration can change across channels because of the artifact detection
            ...
            'total_NREM_valid_min' : 'Valid (no artifact) period for detection - Valid duration (min) of the sleep period in NREM stage minus the REM periods if excluded.',
            ...
            'total_NREM_spindle_count' : 'Total - Sleep spindle count in NREM stage.',
            ...
            'total_NREM_density' : 'Total - Spindle density (count/min) in NREM stage.',
            ...
            'total_NREM_spindle_sec' : 'Total - Average spindle duration (s) in NREM stage.',
            ...
            'total_NREM_dom_freq_Hz' : 'Total - Spindle dominant frequency (Hz) where spectral energy is maximum in NREM stage.',
            ...
            'total_NREM_avg_freq_Hz' : 'Total - Spindle average frequency (Hz) counting peaks in NREM stage.',
            ...
            'total_NREM_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (µV) in NREM stage.',
            ...
            'total_NREM_amp_rms_uV' : 'Total - Average rms amplitude (µV) in NREM stage.',
    ...
    for i_cycle in range(N_CYCLE):
        current_cycle_dict = \
            ...
            f'cyc{i_cycle+1}_NREM_valid_min' : f'Cycle {i_cycle+1} - Valid (no artifact) duration (min) in NREM stage available for detection minus the REM periods if excluded.',
            ...
            f'cyc{i_cycle+1}_NREM_spindle_count' : f'Cycle {i_cycle+1} - Sleep spindle count in NREM stage.',
            ...
            f'cyc{i_cycle+1}_NREM_density' : f'Cycle {i_cycle+1} - Spindle density (count/min) in NREM stage.',
            ...
            f'cyc{i_cycle+1}_NREM_spindle_sec' : f'Cycle {i_cycle+1} - Average spindle duration (s) in NREM stage.',
            ...
            f'cyc{i_cycle+1}_NREM_dom_freq_Hz' : f'Cycle {i_cycle+1} - Spindle dominant frequency (Hz) where spectral energy is maximum in NREM stage.',
            ...
            f'cyc{i_cycle+1}_NREM_avg_freq_Hz' : f'Cycle {i_cycle+1} - Spindle average frequency (Hz) counting peaks in NREM stage.',
            ...
            f'cyc{i_cycle+1}_NREM_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (µV) in NREM stage.',
            ...
            f'cyc{i_cycle+1}_NREM_amp_rms_uV' : f'Cycle {i_cycle+1} - Average rms amplitude (µV) in NREM stage.',
