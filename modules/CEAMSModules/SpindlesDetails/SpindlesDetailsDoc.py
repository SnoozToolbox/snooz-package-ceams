...
def _get_doc(N_CYCLE, spindle_event_name, N_HOURS=0):
    ...
    {            # The valid duration can change across channels because of the artifact detection
            ...
            'total_N1_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N1 stage (µV·sec).',
            'total_N2_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 stage (µV·sec).',
            'total_N3_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N3 stage (µV·sec).',
            'total_N2N3_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 and N3 stage (µV·sec).',
            'total_NREM_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in NREM stage (N1, N2, N3) (µV·sec).',
            'total_R_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in REM stage (µV·sec).',
            'total_RSAI_uVsec' : 'Total - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in all stages (µV·sec)'}
    cycle_dict = {}
    for i_cycle in range(N_CYCLE):
        current_cycle_dict = \
            ...
            f'cyc{i_cycle+1}_N1_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N1 stage (µV·sec).',
            f'cyc{i_cycle+1}_N2_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 stage (µV·sec).',
            f'cyc{i_cycle+1}_N3_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N3 stage (µV·sec).',
            f'cyc{i_cycle+1}_N2N3_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 and N3 stage (µV·sec).',
            f'cyc{i_cycle+1}_NREM_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in NREM stage (N1, N2, N3) (µV·sec).',
            f'cyc{i_cycle+1}_R_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in REM stage (µV·sec).',
            f'cyc{i_cycle+1}_RSAI_uVsec' : f'Cycle {i_cycle+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in all stages (µV·sec)'}
    ...
    for i_hour in range(N_HOURS):
        current_hour_dict = \
            ...
            f'clock_h{i_hour+1}_N1_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N1 stage (µV·sec).',
            f'clock_h{i_hour+1}_N2_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 stage (µV·sec).',
            f'clock_h{i_hour+1}_N3_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N3 stage (µV·sec).',
            f'clock_h{i_hour+1}_N2N3_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 and N3 stage (µV·sec).',
            f'clock_h{i_hour+1}_NREM_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in NREM stage (N1, N2, N3) (µV·sec).',
            f'clock_h{i_hour+1}_R_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in REM stage (µV·sec).',
            f'clock_h{i_hour+1}_RSAI_uVsec' : f'Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in all stages (µV·sec)'}
    ...
    for i_hour in range(N_HOURS):
        current_stage_hour_dict = \
            ...
            f'stage_h{i_hour+1}_N1_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N1 stage (µV·sec).',
            f'stage_h{i_hour+1}_N2_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 stage (µV·sec).',
            f'stage_h{i_hour+1}_N3_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N3 stage (µV·sec).',
            f'stage_h{i_hour+1}_N2N3_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in N2 and N3 stage (µV·sec).',
            f'stage_h{i_hour+1}_NREM_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in NREM stage (N1, N2, N3) (µV·sec).',
            f'stage_h{i_hour+1}_R_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in REM stage (µV·sec).',
            f'stage_h{i_hour+1}_RSAI_uVsec' : f'Stage Hour {i_hour+1} - RMS Spindle Activity Index (sum of RMS amplitude × spindle duration) in all stages (µV·sec)'}
