...
def _get_doc(N_CYCLE, spindle_event_name, N_HOURS=0):
    ...
    {            # The valid duration can change across channels because of the artifact detection
            ...
            'total_N1_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV) in N1 stage.',
            'total_N2_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV) in N2 stage.',
            'total_N3_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV) in N3 stage.',
            'total_N2N3_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV) in N2 and N3 stage.',
            'total_NREM_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV) in NREM stage (N1, N2, N3).',
            'total_R_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV) in REM stage.',
            'total_amp_pkpk_uV' : 'Total - Average peak-to-peak amplitude (uV)',

            'total_N1_amp_rms_uV' : 'Total - Average rms amplitude (uV) in N1 stage.',
            'total_N2_amp_rms_uV' : 'Total - Average rms amplitude (uV) in N2 stage.',
            'total_N3_amp_rms_uV' : 'Total - Average rms amplitude (uV) in N3 stage.',
            'total_N2N3_amp_rms_uV' : 'Total - Average rms amplitude (uV) in N2 and N3 stage.',
            'total_NREM_amp_rms_uV' : 'Total - Average rms amplitude (uV) in NREM stage (N1, N2, N3).',
    ...
    for i_cycle in range(N_CYCLE):
        current_cycle_dict = \
            ...
            f'cyc{i_cycle+1}_N1_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in N1 stage.',
            f'cyc{i_cycle+1}_N2_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in N2 stage.',
            f'cyc{i_cycle+1}_N3_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in N3 stage.',
            f'cyc{i_cycle+1}_N2N3_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in N2 and N3 stage.',
            f'cyc{i_cycle+1}_NREM_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in NREM stage (N1, N2, N3).',
            f'cyc{i_cycle+1}_R_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in REM stage.',
            f'cyc{i_cycle+1}_amp_pkpk_uV' : f'Cycle {i_cycle+1} - Average peak-to-peak amplitude (uV) in all stages',

            f'cyc{i_cycle+1}_N1_amp_rms_uV' : f'Cycle {i_cycle+1} - Average rms amplitude (uV) in N1 stage.',
            f'cyc{i_cycle+1}_N2_amp_rms_uV' : f'Cycle {i_cycle+1} - Average rms amplitude (uV) in N2 stage.',
            f'cyc{i_cycle+1}_N3_amp_rms_uV' : f'Cycle {i_cycle+1} - Average rms amplitude (uV) in N3 stage.',
            f'cyc{i_cycle+1}_N2N3_amp_rms_uV' : f'Cycle {i_cycle+1} - Average rms amplitude (uV) in N2 and N3 stage.',
            f'cyc{i_cycle+1}_NREM_amp_rms_uV' : f'Cycle {i_cycle+1} - Average rms amplitude (uV) in NREM stage (N1, N2, N3).',
    ...
    for i_hour in range(N_HOURS):
        current_hour_dict = \
            ...
            f'clock_h{i_hour+1}_N1_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N1 stage.',
            f'clock_h{i_hour+1}_N2_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N2 stage.',
            f'clock_h{i_hour+1}_N3_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N3 stage.',
            f'clock_h{i_hour+1}_N2N3_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N2 and N3 stage.',
            f'clock_h{i_hour+1}_NREM_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in NREM stage (N1, N2, N3).',
            f'clock_h{i_hour+1}_R_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in REM stage.',
            f'clock_h{i_hour+1}_amp_pkpk_uV' : f'Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in all stages',

            f'clock_h{i_hour+1}_N1_amp_rms_uV' : f'Hour {i_hour+1} - Average rms amplitude (uV) in N1 stage.',
            f'clock_h{i_hour+1}_N2_amp_rms_uV' : f'Hour {i_hour+1} - Average rms amplitude (uV) in N2 stage.',
            f'clock_h{i_hour+1}_N3_amp_rms_uV' : f'Hour {i_hour+1} - Average rms amplitude (uV) in N3 stage.',
            f'clock_h{i_hour+1}_N2N3_amp_rms_uV' : f'Hour {i_hour+1} - Average rms amplitude (uV) in N2 and N3 stage.',
            f'clock_h{i_hour+1}_NREM_amp_rms_uV' : f'Hour {i_hour+1} - Average rms amplitude (uV) in NREM stage (N1, N2, N3).',
    ...
    for i_hour in range(N_HOURS):
        current_stage_hour_dict = \
            ...
            f'stage_h{i_hour+1}_N1_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N1 stage.',
            f'stage_h{i_hour+1}_N2_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N2 stage.',
            f'stage_h{i_hour+1}_N3_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N3 stage.',
            f'stage_h{i_hour+1}_N2N3_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in N2 and N3 stage.',
            f'stage_h{i_hour+1}_NREM_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in NREM stage (N1, N2, N3).',
            f'stage_h{i_hour+1}_R_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in REM stage.',
            f'stage_h{i_hour+1}_amp_pkpk_uV' : f'Stage Hour {i_hour+1} - Average peak-to-peak amplitude (uV) in all stages',

            f'stage_h{i_hour+1}_N1_amp_rms_uV' : f'Stage Hour {i_hour+1} - Average rms amplitude (uV) in N1 stage.',
            f'stage_h{i_hour+1}_N2_amp_rms_uV' : f'Stage Hour {i_hour+1} - Average rms amplitude (uV) in N2 stage.',
            f'stage_h{i_hour+1}_N3_amp_rms_uV' : f'Stage Hour {i_hour+1} - Average rms amplitude (uV) in N3 stage.',
            f'stage_h{i_hour+1}_N2N3_amp_rms_uV' : f'Stage Hour {i_hour+1} - Average rms amplitude (uV) in N2 and N3 stage.',
            f'stage_h{i_hour+1}_NREM_amp_rms_uV' : f'Stage Hour {i_hour+1} - Average rms amplitude (uV) in NREM stage (N1, N2, N3).',
