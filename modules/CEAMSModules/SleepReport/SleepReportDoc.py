...
def _get_doc(N_CYCLES):
    ...
    {        
        ...
        'first_epoch_time_win':'The timestamp of the first epoch (yyyy-mm-dd hh:mm:ss).',
        'last_epoch_time_win':'The timestamp of the last epoch (yyyy-mm-dd hh:mm:ss).',
        'time_in_bed_min':'(TIB) Total elapsed time between lights-off (first stage scored as awake or asleep) and lights-on (end of last stage scored as awake or asleep). Unscored epochs at the beginning and end of the recording are excluded.',
        'sleep_period_min':'(SPT) Duration of the sleep period defined as the time between the sleep onset and the last sleep stage (N1,N2,N3,R) in minutes.',
        ...
        'total_sleep_min':'(TST) The total sleep time is defined as: sleep_period_min - total_W_min - (Movement duration) - Unscored_min.',
        'last_wake_min':'Duration of the last wake period of the sleep period in minutes.',
        'sleep_efficiency':'Defined as the time spend in a sleep stage over the total time in bed (TIB) x 100.',
        'sleep_maintenance_efficiency':'Defined as the time spend in a sleep stage over the duration of the sleep period (SPT) x 100.',
        ...
        'total_W_min':'Total time spent in wake during the sleep period in minutes.',
        'total_N1_min':'Total time spent in N1 during the sleep period in minutes.',
        'total_N2_min':'Total time spent in N2 during the sleep period in minutes.',
        'total_N3_min':'Total time spent in N3 during the sleep period in minutes.',
        'total_R_min':'Total time spent in REM stage during the sleep period in minutes.',
        'total_Unscored_min':'Total time spent in Unscored stage during the sleep period in minutes.',
        'total_N1N2N3_min':'Total time spent in NREM stages during the sleep period in minutes.',
