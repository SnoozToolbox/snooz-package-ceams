...
class Ui_PSAPicsGeneratorSettingsView(object):
    ...
    def retranslateUi(self, PSAPicsGeneratorSettingsView):
        ...
        self.add_pushButton.setText(QCoreApplication.translate("PSAPicsGeneratorSettingsView", u"Add PSA File", None))
        ...
        self.label_4.setText(QCoreApplication.translate("PSAPicsGeneratorSettingsView", u"PSA File information", None))
    # retranslateUi
