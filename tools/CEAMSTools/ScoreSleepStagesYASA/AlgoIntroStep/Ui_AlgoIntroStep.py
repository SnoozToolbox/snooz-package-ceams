...
class Ui_AlgoIntroStep(object):
    def setupUi(self, AlgoIntroStep):
        ...
        self.scrollArea.setMaximumSize(QSize(16777215, 460))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 950, 460))
        self.scrollAreaWidgetContents.setMaximumSize(QSize(16777215, 460))
        ...
        self.label_4.setMaximumSize(QSize(16777215, 460))
    ...
    def retranslateUi(self, AlgoIntroStep):
        ...
        self.label_2.setText(QCoreApplication.translate("AlgoIntroStep", u"<html><head/><body><p>This tool <span style=\" font-weight:700;\">classifies sleep stages</span> from PSG recordings using 30-second epochs.</p><p>Sleep stages can be classified based on a single EEG electrode, preferably central ones (C3, C4).<br/>Including one EOG and one EMG channel can improve classification accuracy.</p><p align=\"justify\"><span style=\" font-weight:700;\">In Snooz, you can select up to four high-priority EEG channels</span>, <br/>allowing the tool to determine the most confident classification for each. </p><p align=\"justify\">NOTE: Based on the internal analysis of Snooz, configurations combining central channels <br/>with one frontal and one occipital channel typically demonstrate marginally better performance.</p></body></html>", None))
        ...
        self.label_4.setText(QCoreApplication.translate("AlgoIntroStep", u"<html><head/><body><p>The sleep staging algorithm, YASA, is an open-source tool that has been trained,<br/>using over 30,000 hours of polysomnographic (PSG) sleep data across diverse populations. </p><p><span style=\" font-weight:600;\">Data processing:</span><br/>The algorithm uses a central EEG channel, along with EOG, and EMG channels.<br/>These signals are downsampled to 100 Hz and bandpassed-filtered between 0.4 Hz and 30 Hz. </p><p><span style=\" font-weight:600;\">Feature Extraction:</span><br/>The algorithm extracts a set of time and frequency domain features from the EEG signal, <br/>and optionaly from the EOG and EMG signals. These features are calculated for each 30-second epoch of raw data. </p><p><span style=\" font-weight:600;\">Smoothing and Normalization:</span><br/>The algorithm uses a smoothing approach across all the aformentioned features to incorporate contextual infromation.<br/>All the smoothed features are then z-scored across each night. </p><p><span style=\" font-weight:600;\">Machine"
                        " Learning Classification:</span><br/>A lightGBM classifier, a tree-based gradient-boosting classifier, is used. </p><p><span style=\" font-weight:600;\">Performance Evaluation:</span><br/>The algorithm's performance is evaluated using standardized guidelines,<br/>including accuracy, Cohen's kappa, Matthews correlation coefficient, confusion matrices, and F1-scores. </p><p><span style=\" text-decoration: underline;\">Reference</span>: <br/>Vallat, Raphael, and Matthew P. Walker. \u201cAn open-source, high-performance tool for automated sleep staging.\u201d Elife 10 (2021). <br/>doi: https://doi.org/10.7554/eLife.70092 (Documentation: <a href=\"https://raphaelvallat.com/yasa/\"><span style=\" text-decoration: underline; color:#0000ff;\">https://raphaelvallat.com/yasa/)<br/></span></a></p></body></html>", None))
