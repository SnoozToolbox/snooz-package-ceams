...
################################################################################
## Form generated from reading UI file 'Ui_ModifyCriteriaDialog.ui'
##
...
class Ui_ModifyCriteriaDialog(object):
    def setupUi(self, ModifyCriteriaDialog):
        ...
        ModifyCriteriaDialog.resize(426, 402)
    ...
    def retranslateUi(self, ModifyCriteriaDialog):
        ...
        self.events_in_combobox.setItemText(4, QCoreApplication.translate("ModifyCriteriaDialog", u"EOG_Phasic", None))
        self.events_in_combobox.setItemText(5, QCoreApplication.translate("ModifyCriteriaDialog", u"EOG_Tonic", None))
